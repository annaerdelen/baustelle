<template>
  ...
  >
    ...
    <span class="origin-bottom-left" :class="[{ '-rotate-45 translate-y-[0.085rem] translate-x-[0.5rem]': globalStore.isNavOpen }, classes]" />
  </button>
</template>
...
const classes = 'block h-[1px] w-[20px] bg-black duration-200 ease-out-quart';
</script>
